#source('/home/gorgens/Documents/R logging criteria/10_creatingDataBase.R')
#setwd('/home/gorgens/Documents/R logging criteria/')
...
PATH = './inventariosPaisagens/'
COMPL = './complementosPaisagens/'
EXPORT = './outputs/'
...
write.csv(inv.paisagens, '10_invPaisagensMerged.csv')
