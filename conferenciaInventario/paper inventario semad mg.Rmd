...
write.csv(simuladoAggregate, 'simulado.csv')
```
...
```{r plotTestet, echo = FALSE}
ggplot(simuladoAggregate, aes(difMedia, difSd, z = conf_t)) + 
...
```{r plotKs, echo = FALSE}
ggplot(simuladoAggregate, aes(difMedia, difSd, z = conf_ks)) + 
  geom_contour_filled() + ylab('Desvio padrão da diferença (cm)') +
  xlab('Diferença média do DAP (cm)')
```
...
ggplot(simuladoAggregate, aes(difMedia, difSd, z = conf_graybill)) + 
  geom_contour_filled() + ylab('Desvio padrão da diferença (cm)') +
  xlab('Diferença média do DAP (cm)')
```
...
ggplot(simuladoAggregate, aes(difMedia, difSd, z = erroInvConf)) + 
  geom_contour_filled() + ylab('Desvio padrão da diferença (cm)') +
  xlab('Diferença média do DAP (cm)')
```
...
ggplot(simuladoAggregate, aes(difMedia, difSd, z = diffErro)) + 
  geom_contour_filled() + ylab('Desvio padrão da diferença (cm)') +
  xlab('Diferença média do DAP (cm)')
```
...
```{r invt, echo = FALSE}
ggplot(simuladoAggregate, aes(difMedia, difSd, z = inv_t)) + 
  geom_contour_filled() + ylab('Desvio padrão da diferença (cm)') +
  xlab('Diferença média do DAP (cm)')
```
...
```{r invks, echo = FALSE}
ggplot(simuladoAggregate, aes(difMedia, difSd, z = inv_ks)) + 
  geom_contour_filled() + ylab('Desvio padrão da diferença (cm)') +
  xlab('Diferença média do DAP (cm)')
```
...
ggplot(simuladoAggregate, aes(difMedia, difSd, z = inv_graybill)) + 
  geom_contour_filled() + ylab('Desvio padrão da diferença (cm)') +
  xlab('Diferença média do DAP (cm)')
```
